...
if __name__ == '__main__':
    ...
    np.savez('pd1', V1_STN_array=V1_STN_array[:,10000:30000], V1_GPE_array=V1_GPE_array[:,10000:30000], V1_GPI_array=V1_GPI_array[:,10000:30000], V1_TH_array=V1_TH_array[:,10000:30000])
