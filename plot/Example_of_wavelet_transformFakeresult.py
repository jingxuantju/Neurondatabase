...
data0 = np.piecewise(t, [t < 1, t < 0.7, t < 0.3],
                     [lambda t: 0 * np.sin(2 * np.pi * f3 * t),
                      lambda t: 150 * np.sin(2 * np.pi * f2 * 5 * t),
                      lambda t: 0 * np.sin(2 * np.pi * f1 * t)])
data01 = np.piecewise(t, [t < 1, t < 0.7, t < 0.3],
                      [lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 200 * np.sin(2 * np.pi * f3 * 10 * t),
                       lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t)])
data02 = np.piecewise(t, [t < 1, t < 0.7, t < 0.3],
                      [lambda t: 40 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 120 * np.sin(2 * np.pi * f1 * 10 * t),
                       lambda t: 40 * np.sin(2 * np.pi * f2 * 10 * t)])
...
data11 = np.piecewise(t, [t < 1, t < 0.72, t < 0.69, t < 0.31, t < 0.28],
                      [lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 150 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 20 * np.sin(2 * np.pi * f3 * 10 * t),
                       lambda t: 150 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t)])
data12 = 0.03 * kd * np.piecewise(t, [t < 1, t < 0.72, t < 0.69, t < 0.31, t < 0.28],
...
data21 = np.piecewise(t, [t < 1, t < 0.72, t < 0.69, t < 0.31, t < 0.28],
                      [lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t),
                       ...
                       lambda t: 230 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t)])
data22 = np.piecewise(t, [t < 1, t < 0.72, t < 0.69, t < 0.31, t < 0.28],
                      [lambda t: 40 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 130 * np.sin(2 * np.pi * f1 * 10 * t),
...
data33 = np.piecewise(t, [t < 1, t < 0.72, t < 0.69, t < 0.31, t < 0.28],
                      [lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 130 * np.sin(2 * np.pi * f3 * 10 * t),
                       lambda t: 160 * np.sin(2 * np.pi * f2 * 10 * t),
                       lambda t: 130 * np.sin(2 * np.pi * f3 * 10 * t),
                       lambda t: 50 * np.sin(2 * np.pi * f2 * 10 * t)])
...
cf1 = plt.contourf(t, frequencies1, abs(cwtmatr1),levels=np.linspace(0,400,100),extend='both')
cbar1=plt.colorbar(cf1,ticks=[0,100,200,300,400])
...
cf2 = plt.contourf(t, frequencies2, abs(cwtmatr2),levels=np.linspace(0,400,100),extend='both')
cbar2=plt.colorbar(cf2,ticks=[0,100,200,300,400])
...
plt.axis('off')
plt.subplot(grid[1:3, 0])
cf3 = plt.contourf(t, frequencies3, abs(cwtmatr3),levels=np.linspace(0,400,100),extend='both')
cbar3=plt.colorbar(cf3,ticks=[0,100,200,300,400])
...
plt.axis('off')
plt.subplot(grid[1:3, 1])
cf4 = plt.contourf(t, frequencies4, abs(cwtmatr4),levels=np.linspace(0,400,100),extend='both')
cbar4=plt.colorbar(cf3,ticks=[0,100,200,300,400])
cbar4.set_ticklabels(ticklabels)
plt.xticks([0.0, 0.2, 0.4, 0.6, 0.8, 0.99], [0, 1000, 2000, 3000, 4000, 5000])
plt.yticks([10, 167, 333, 500], [10, 20, 30, 40])
plt.ylabel("频率(Hz)", fontdict={'family': 'SimHei', 'size': 14})
plt.xlabel("时间(ms)", fontdict={'family': 'SimHei', 'size': 14})
