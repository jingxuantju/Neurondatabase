...
plt.subplot(311)
plt.plot(Ilfp_stn_gpe, c='lightcoral', linewidth=2)
...
plt.subplot(313)
plt.plot(Ilfp_gpi_tc, c='powderblue', linewidth=2)
plt.xlim(2000, t_span)
plt.yticks(fontproperties='Times New Roman', size=14)
plt.xticks(fontproperties='Times New Roman', size=14)
...
plt.plot(Ilfp, c='lightsteelblue', linewidth=2)

plt.plot(Ilfp_stn_gpi, c='mistyrose', linewidth=2)
plt.plot(Ilfp_stn_gpe, c='indianred', linewidth=2)
plt.xlim(2000, t_span)
plt.yticks(fontproperties='Times New Roman', size=14)
plt.xticks(fontproperties='Times New Roman', size=14)
plt.ylabel('不同核团的平均电流', fontdict={'family': 'SimHei', 'size': 14})
